    ...
    return(
        ...
        <div>
            <div className="buttons">
                <StepBackwardOutlined className="forback" onClick="" />
                {playing ?
                    <PauseCircleFilled className="pauseplay" onClick="" /> :
                    <PlayCircleFilled className="pauseplay" onClick="" />
                }
                <StepForwardOutlined className="forback" onClick="" />
            </div>
            <div className="buttons">
                00:00
                <Slider
